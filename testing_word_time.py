...
word_sizes = list(range(4, 20, 1))   # Example word sizes to test
seq_lengths = list(range(50, 1000, 50)) # Example sequence lengths to test
...
for i, w in enumerate(word_sizes):
    for j, s in enumerate(seq_lengths):
        ...
        print(f"Word size: {w}, Seq length: {s}, Time: {runtime:.4f} s")
